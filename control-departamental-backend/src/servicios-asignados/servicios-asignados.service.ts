...
export class ServiciosAsignadosService {
  ...
  async findAllPagos(id_user: UUID) {
    console.log("findAllPagosss");
    
    try {
      console.log("findAllPago2s");
      ...
      //   }
      // }
      const pagablesFiltrados = pagables.filter(p => p.pago !== null);
      console.log(pagablesFiltrados);
      return pagablesFiltrados;
  ...
  async findAllPagosUser(id_user: UUID) {
    try {
      ...
      //   }
      // }
      return pagables.filter(p => p.pago !== null);
